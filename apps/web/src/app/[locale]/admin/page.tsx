...
export const generateMetadata = async ({ params }: { params: Promise<{ locale: iGM_Locale }> }) =>
  iGM_pageMetadata((await params).locale, 'G_Admin');

// ==================== 区块：页面 ====================
export default async function iGM_AdminPage({
  params,
}: {
  ...
  return <IGM_PagePlaceholder title={t('G_Admin')} />;
}
